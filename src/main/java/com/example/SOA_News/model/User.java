...
public class User {
    ...
    @ElementCollection
    @CollectionTable(name = "user_saved_articles", 
                     joinColumns = @JoinColumn(name = "user_id"))
    @Column(name = "article_url", length = 1000)
    private List<String> savedArticleUrls = new ArrayList<>();
    ...
    public List<String> getSavedArticleUrls() {
        return savedArticleUrls;
    }
    
    public void setSavedArticleUrls(List<String> savedArticleUrls) {
